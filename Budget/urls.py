# =============================================================================
#  Budget/urls.py — BudgetTracker App URL Configuration
...
urlpatterns = [
    ...
    # ── Categories (AJAX) ────────────────────────────────────────────────────
    # POST-only endpoint called by the Add Expense / Add Income pages
    ...
    # ── ML Category Prediction (AJAX) ────────────────────────────────────────
    # GET-only, read-only endpoint called (debounced) while the user types
    # a description on the Add Expense / Add Income pages.
    path('predict-category/', views.predict_category_ajax, name='predict_category_url'),
